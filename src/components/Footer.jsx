...
const Footer = () => (
  <footer className="foot" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1.5rem 2rem", borderTop: "1px solid var(--border)", fontSize: "0.7rem", color: "var(--mutedL)", flexWrap: "wrap", gap: "1rem" }}>
    <span>&copy; 2026 Nofar Baram</span>
    ...
    <span style={{ letterSpacing: "0.04em" }}>UX/UI & Product Designer</span>
  </footer>
);
